...
class Mechanics(Base):
    ...
    ticket_mechanics: Mapped[list['Ticket_mechanics']] = relationship('Ticket_mechanics', back_populates='mechanic')
...
#     mechanic: Mapped['Mechanics'] = relationship('Mechanics', back_populates='ticket_mechanics')
